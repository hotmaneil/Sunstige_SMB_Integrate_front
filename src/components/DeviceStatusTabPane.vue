<template>
  <div>
    ...
    >
      ...
      <!--隱藏-->
      <!-- <el-table-column prop="CimMode" label="CimMode" align="center" sortable="custom">
        <template slot-scope="scope">
          {{ scope.row.CimMode }}
        </template>
      </el-table-column> -->
...
<script>
import { equipmentStatus } from '@/api/Equipments'
...
export default {
  ...
  methods: {
    async getResponseList() {
      ...
      await this.GET_EquipmentsStatusList()
        .then(response => {
        // console.log('GET_EquipmentsStatusList', response)
    ...
    GET_EquipmentsStatusList() {
      return new Promise((resolve, reject) => {
        ...
        const payload = {
          ...
          select_: 'TriggerTime,CimMode,Status',
        ...
        console.log('GET_EquipmentsStatusList payload', payload)
